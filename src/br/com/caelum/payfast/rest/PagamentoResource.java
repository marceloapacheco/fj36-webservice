...
public class PagamentoResource {
	...
	public Response criarPagamento(Transacao transacao) throws URISyntaxException {
		...
		return Response.created(new URI("/pagamentos/" + pagamento.getId()))
				.entity(pagamento).type(MediaType.APPLICATION_JSON_TYPE).build();			
	}
	
	@PUT
	@Path("/{id}")
	@Produces({MediaType.APPLICATION_JSON})
	public Pagamento confirmarPagamento(@PathParam("id") Integer pagamentoId) throws URISyntaxException {
